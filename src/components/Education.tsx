...
function SkillCard({
  ...
  return (
    <div className="rounded-2xl bg-white/10 p-5 sm:p-6 transition hover:bg-white/15 text-center h-full">
...
function Skill({
  ...
  return (
    <li className="flex items-center justify-center gap-3 text-white/80 text-sm sm:text-base">
      {icon ? (
        <span className="text-xl text-red-400">{icon}</span>
      ) : (
        <img src={iconSrc} alt={label} className="h-8 w-8" />
    ...
    <section id="skill" className="scroll-mt-24">
      <div className="bg-[url('/chat-gpt.png')] bg-cover bg-center">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 sm:py-16 lg:py-20">
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-3 mx-auto items-stretch">
            <SkillCard title="Front-End">
              <Skill icon={<FaHtml5 />} label="HTML5" />
              <Skill icon={<FaCss3Alt />} label="CSS3" />
              <Skill icon={<FaJs />} label="JavaScript (ES6+)" />
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 mx-auto pt-10 sm:pt-12 lg:pt-15">
            <SkillCard title="Machine Learning Algorithm">
              <Skill icon={<SiTensorflow />} label="Neural Network" />
              <Skill icon={<SiTensorflow />} label="Logistic Regression" />
              <Skill icon={<SiTensorflow />} label="XGBoost" />
