...
// ✅ EmailJS mapping for template variables
function toEmailJsParams(values: ContactFormValues) {
  return {
    name: values.Name,
    title: values.Title,
...
export default function Contact() {
  ...
  return (
    <section>
      <div className="bg-[url('/chat-gpt.png')] bg-cover bg-center">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 sm:py-16 lg:py-20">
          <h4
            id="contact"
            className="mb-8 sm:mb-10 font-bold text-white text-3xl sm:text-[36px] font-josefin text-center scroll-mt-24"
          >
            Get In Touch
          </h4>
          ...
          >
            {({ isSubmitting, touched, errors }) => (
              <Form className="relative grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2 pt-1 md:pr-5">
                  <Field
                    name="Name"
                    placeholder={
                      touched.Name && errors.Name ? errors.Name : "Name *"
                ...
                <div className="md:col-span-2 mt-2">
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="group relative w-full sm:w-[180px] h-10 px-8 py-3 text-[15px] font-open font-bold text-white border-2 border-white bg-[#ffc107] overflow-hidden transition-all duration-300 hover:bg-transparent"
                  >
                    <span className="absolute inset-0 flex items-center justify-center transition-all duration-300 group-hover:opacity-0 group-hover:scale-90">
                      {isSubmitting ? "Sending..." : "Send Message"}
                    </span>
          ...
          <div className="mt-12 grid gap-6 sm:gap-8 md:grid-cols-3">
            <div className="flex items-start gap-4">
              <MdOutlinePhonelink className="h-[25px] w-[25px] text-[#C49B66]" />
              <div className="hidden sm:block w-px h-10 border-l border-white/60" />
              <div>
                <h6 className="text-[14px] font-josefin font-bold text-white pb-1">
                  Phone
                </h6>
                <p className="text-[15px] font-open text-[#a3a3a3]">
                  +62 858 7143 9193
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              <IoIosMailOpen className="h-[25px] w-[25px] text-[#C49B66]" />
              <div className="hidden sm:block w-px h-10 border-l border-white/60" />
              <div>
                <h6 className="text-[14px] font-josefin font-bold text-white pb-1">
                  Email
                </h6>
                <p className="text-[15px] font-open text-[#a3a3a3] break-words">
                  husniramandalubis@gmail.com
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              <FiMapPin className="h-[25px] w-[25px] text-[#C49B66]" />
              <div className="hidden sm:block w-px h-10 border-l border-white/60" />
              <div>
                <h6 className="text-[14px] font-josefin font-bold text-white pb-1">
                  Address
